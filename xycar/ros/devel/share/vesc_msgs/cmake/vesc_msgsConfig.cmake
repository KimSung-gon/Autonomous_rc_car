...
if("TRUE" STREQUAL "TRUE")
  set(vesc_msgs_SOURCE_PREFIX /home/nvidia/xycar/ros/src/vesc/vesc_msgs)
  set(vesc_msgs_DEVEL_PREFIX /home/nvidia/xycar/ros/devel)
  ...
  set(vesc_msgs_INSTALL_PREFIX /home/nvidia/xycar/ros/install)
...
if(NOT "/home/nvidia/xycar/ros/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vesc_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/xycar/ros/src/vesc/vesc_msgs/${idir}'.  ${_report}")
    endif()
