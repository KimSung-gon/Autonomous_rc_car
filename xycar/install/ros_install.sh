...
function usage {
    ...
    echo >&2 "usage: $0 [catkin workspace name (default:xycar/ros)] [ROS distro (default: kinetic)"
...
name_catkinws=$1
name_catkinws=${name_catkinws:="xycar/ros"}
name_ros_distro=$2
...
sh -c "echo \"alias cw='cd ~/xycar/ros'\" >> ~/.bashrc"
sh -c "echo \"alias cs='cd ~/xycar/ros/src'\" >> ~/.bashrc"
sh -c "echo \"alias cm='cd ~/xycar/ros && catkin_make'\" >> ~/.bashrc"
